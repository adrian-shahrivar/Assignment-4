...
class Page {
    constructor(){
        this.sName = "Adrian Shahrivar";
        this.sUrlToEmailer = "https://enigmatic-cove-24065.herokuapp.com/send/";
    ...
    render() {
        ...
        <form action="${this.sUrlToEmailer}" method="POST">
            <div class="form-group">
                <label>Name: <input name="name" placeholder="Enter Name Here" class="form-control" required /></label>
            </div>
            <div class="form-group">
